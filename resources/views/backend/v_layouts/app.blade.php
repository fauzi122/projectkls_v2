            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-shopping"></i><span class="hide-menu">Data Pesanan </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a href="{{ route('pesanan.proses') }}" class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span class="hide-menu"> Proses </span></a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{{ route('pesanan.selesai') }}" class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span class="hide-menu"> Selesai </span></a>
                                </li>
                            </ul>
                        </li>
